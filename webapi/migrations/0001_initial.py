# Generated by Django 4.0.4 on 2022-10-28 20:17
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('place_id', models.CharField(blank=True, default='', max_length=30)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('passengers', models.ManyToManyField(related_name='+', to=settings.AUTH_USER_MODEL)),
                ('points', models.ManyToManyField(to='webapi.point')),
                ('status', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='webapi.tripstatus')),
            ],
        ),
        migrations.CreateModel(
            name='Review',
